...
public class UiSkin {
    ...
    public static void loadSkin() {
        ...
        TextureAtlas.AtlasRegion tooltipRegion = atlas.addRegion("tooltip-window", tooltipTexture, 0, 0,
                tooltipTexture.getWidth(), tooltipTexture.getHeight());
        ...
        atlas.addRegion("save-select", saveSelectTexture, 0, 0, saveSelectTexture.getWidth(),
                saveSelectTexture.getHeight());
        TextureAtlas.AtlasRegion tableHoverAtlas = atlas.addRegion("table-hover", tableHover, 0, 0,
                tableHover.getWidth(), tableHover.getHeight());
        TextureAtlas.AtlasRegion tableNoHoverAtlas = atlas.addRegion("table-no-hover", tableNoHover, 0, 0,
                tableNoHover.getWidth(), tableNoHover.getHeight());

        // inventory
        atlas.addRegion("inventory-window", inventoryWindowTexture, 0, 0, inventoryWindowTexture.getWidth(),
                inventoryWindowTexture.getHeight());
        ...
        font = new BitmapFont(Game.findInternalFileInMods("ui/pixel.fnt"), Game.findInternalFileInMods("ui/pixel.png"),
                false, true);
