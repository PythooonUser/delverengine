    ...
    public EditorUi() {
        ...
        menuBar.addItem(
            new MenuItem("Tile", smallSkin)
                ...
                .addSeparator()
                .addItem(
                    new MenuItem("Selection Mode", smallSkin)
                        .addItem(new MenuItem("Vertex Select", smallSkin, actions.setVertexSelectionModeAction))
                        .addItem(new MenuItem("Edge Select", smallSkin, actions.setEdgeSelectionModeAction))
                        .addItem(new MenuItem("Face Select", smallSkin, actions.setFaceSelectionModeAction))
                        .addItem(new MenuItem("Toggle", smallSkin, actions.toggleSelectionModeAction).setAccelerator(new MenuAccelerator(Keys.V, false, false)))
                )
