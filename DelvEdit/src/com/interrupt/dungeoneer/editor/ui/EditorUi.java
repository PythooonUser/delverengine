        ...
        menuBar.addItem(
            new MenuItem("Tile", smallSkin)
                ...
                .addItem(new MenuItem("Height Edit Mode", smallSkin)
                    .addItem(new MenuItem("Plane", smallSkin, actions.planeHeightEditModeAction))
                    .addItem(new MenuItem("Vertex", smallSkin, actions.vertexHeightEditModeAction))
                    .addItem(new MenuItem("Toggle", smallSkin, actions.heightEditModeToggleAction).setAccelerator(new MenuAccelerator(Keys.V, false, false)))
                )
